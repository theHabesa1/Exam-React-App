             ...
             <div id={style.headerMenuBox}>
                ...
                <div id={style.sideMenubar}>
                         ...
                         <div id={style.sideMenubarList}>
                            <NavLink exact className={style.removeUnderline} to="/AdminDashboard/Subject"> <button > <span> <BookIcon/> Subject </span></button></NavLink>
                            <NavLink exact className={style.removeUnderline} to="/AdminDashboard/Exam"> <button > <span> <QuizIcon/> Exam </span></button></NavLink>
                            <NavLink exact className={style.removeUnderline} to="/AdminDashboard/Question"> <button > <span> <AddIcon/> Question </span></button></NavLink>
                            <NavLink exact className={style.removeUnderline} to="/AdminDashboard/Result"> <button > <span> <MoneyIcon/> Result </span></button></NavLink>
                            <NavLink exact className={style.removeUnderline} to="/AdminDashboard/StudentList"> <button > <span> <Person2Icon/> StudentList </span></button></NavLink>
                        </div>
                    </div>
